...
ParticleEngine3.prototype.setValues = function( parameters )
{
...
ParticleEngine3.prototype.randomValue = function(base, spread)
{
	return base + spread * (Math.random() - 0.5);
}
ParticleEngine3.prototype.randomVector3 = function(base, spread)
{
...
ParticleEngine3.prototype.createParticle = function()
{
	...
	if (this.positionStyle == Type.SPHERE)
	{
        ...
        var y = 0.1;
        var z = 0.1;
		var vec3 = new THREE.Vector3( 0.1 * Math.cos(x), 0.1 * Math.sin(y), z );
...
ParticleEngine3.prototype.initialize = function()
{
...
ParticleEngine3.prototype.update = function(dt)
{
	var recycleIndices = [];
...
ParticleEngine3.prototype.destroy = function()
{
